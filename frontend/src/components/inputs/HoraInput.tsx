...
//
// El 15-08 se probó reemplazarlo por un desplegable propio con las horas
// en cuartos, para que el elegidor mostrara menos números. Quedó PEOR y
// Felipe lo mandó a devolver: el campo nativo se teclea más rápido y no
// obliga a buscar en una lista. El `step` de 15 minutos se conserva —
// las flechas lo respetan, aunque el desplegable de Chrome lo ignore.
//
...
export default function HoraInput({
  ...
  return (
    <input
      type="time"
      // De a 15 minutos: nadie entra a las 09:07. Las flechas y el
      // teclado saltan por cuartos de hora; el desplegable de Chrome
      // igual muestra todos los minutos, y eso no lo controla la página.
      step={900}
      value={value ?? ""}
