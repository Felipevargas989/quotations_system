...
export default function Tooltip({
  ...
  return (
    <span className="group relative inline-flex" title={titulo}>
      ...
      <span
        role="tooltip"
        className="pointer-events-none invisible absolute bottom-full left-1/2 z-30 mb-1.5 w-max max-w-xs -translate-x-1/2 rounded-lg bg-gray-900 px-2.5 py-1.5 text-left text-xs font-normal leading-relaxed text-white opacity-0 shadow-lg transition-opacity group-hover:visible group-hover:opacity-100"
      >
        {contenido}
      </span>
    </span>
