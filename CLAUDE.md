...
| `components/FijoDeCategoria` | the amber «fijo» seal of a fixed-section item, with its one exception: remove it ONLY in this quotation, behind a ConfirmInline (Felipe, 09-09-2026: 99 % of the time the item must stay; CCU #408 was the 1 %). The catalog is untouched and the next box brings it back. Same piece in the cotizador and in Post-Venta Servicios | 2 |
